...
bool EmergencyLoss(int pips = 200, int index = 0, int select = SELECT_BY_POS)
{
	bool bResult = false;

	if (OrderSelect(index, select) == true){
		// —˜—p’Ê‰Ý‚Ì 1pip ‰¿Ši‚ð‚©‚¯‚Ä‚â‚ç‚È‚¢‚ÆŒvŽZ‚ ‚í‚È‚¢‚æ
...
bool EmergencyTime(int pips = 200, int index = 0, int select = SELECT_BY_POS)
{
	bool bResult = false;
